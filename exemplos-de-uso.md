...
> [!TIP]
> Se a pergunta bater com um dos temas deste guia e o cliente mesmo assim não chamar nenhuma tool, cite no começo do prompt o nome que você deu ao app na instalação (ex.: `@DadosBrasil ...`, se foi esse o nome escolhido) — alguns clientes só consideram um MCP quando ele é citado diretamente, mesmo já conectado.
